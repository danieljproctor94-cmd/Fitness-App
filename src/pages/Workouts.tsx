...
export default function Workouts() {
    ...
    return (
        <div className="flex flex-col p-4 md:p-6 gap-4 lg:h-full lg:min-h-0">
            ...
            <div className="flex-1 flex flex-col lg:flex-row gap-4 lg:min-h-0">
                ...
                <div className={cn(
                    "flex-1 lg:min-h-0 flex flex-col bg-card/20 rounded-xl overflow-hidden shadow-sm border border-border/50",
                    mobileView === 'list' ? "hidden lg:flex" : "flex"
                )}>
                    <BigCalendar
                        workouts={workouts}
