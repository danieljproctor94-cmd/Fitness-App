            ...
            return (
                ...
                >
                    ...
                    <span className="truncate font-medium flex-1">
                        {displayTime && !isPlanner && <span className="font-mono text-[9px] opacity-70 bg-background/30 px-1 py-0.5 rounded-[2px] mr-1 border-r border-border/20 block sm:inline">{displayTime}</span>}
                        {item.name}
                    </span>
        ...
        <>
            <div className="flex flex-col h-full border border-border rounded-xl shadow-sm bg-card/50 overflow-hidden">
                ...
                <div className={cn(
                    ...
                    view === 'month' ? "auto-rows-[1fr] flex-1 min-h-0" : "auto-rows-[1fr] h-full"
                )}>
